package com.javarush.rest_demo.controller;

import com.javarush.rest_demo.model.Client;
import com.javarush.rest_demo.service.ClientService;
...
public class ClientController {
    ...
    */
    ...
    В теле мы получаем объект Client с помощью нашего сервиса и принятого id.
